...
export default async function ContatoPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <h1 className="font-display mb-3 text-3xl sm:text-4xl">Fale com a Fluxo</h1>
      <p className="mb-6 text-graphite">
        Dúvidas sobre pedidos, marcas parceiras ou parcerias? Envie sua mensagem.
      </p>
      ...
      <a
        ...
        className="mb-10 flex items-center gap-3 border border-mist p-4 text-sm transition-colors hover:border-petrol"
      >
        ...
        <span>
          <span className="block text-ink">Prefere falar por WhatsApp?</span>
          <span className="block text-xs text-graphite">Resposta mais rápida para dúvidas de tamanho e prazo.</span>
        </span>
      </a>
